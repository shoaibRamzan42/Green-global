...
const NavBar = () => {
  ...
  return (
    <>
       <nav className="py-6 font-custom  fixed top-0 w-full  bg-transparent px-3 z-[40] lg:px-16 md:px-12 flex justify-between items-center shadow-lg">
      <img src={cLogo} alt="logo" className=" h-[37px]" />
      <div className="flex md:flex-row flex-col-reverse items-center">
        <ul className={`font-custom text-[#ADA9B2] w-full h-screen md:h-0 md:static gap-2 bg-transparent absolute top-20 right-0 p-3 md:p-0   md:bg-transparent md:flex md:flex-row md:gap-4 lg:gap-6 justify-center lg:text-[18px] md:text-[55%]  md:leading-[13px] font-semibold transition-m duration-500 ease-in-out ${menuOpen ? 'max-h-screen' : 'hidden'}`}>
          <li className=' '>
